    ...
    <div className="flex">
      ...
      <div className="w-full ml-20 mr-[30px] ">
        <div className="grid grid-cols-8 auto-rows-[100px] gap-x-[30px] gap-y-[30px] max-h-svh ">
          ...
          <h3 className="text-sm text-gray-400 mr-2"><PiHouseFill className="inline"/> / Driver Analytics / Driver's Name </h3>
          ...
          <div className="col-span-4 row-span-3 col-start-3 row-start-2 border-2 ">
            <EventsLog />
          </div>
          <div className="col-span-2 row-span-3 col-start-7 row-start-2 bg-slate-200 rounded-xl">
            <WarningCount />
          </div>
